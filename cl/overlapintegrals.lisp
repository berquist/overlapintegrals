...
(defun tho66 (alpha1 alpha2 ra rb la lb)
  (let* ((gamma (+ alpha1 alpha2))
         ...
         (wy (overlap1d l1 l2 (- yp ya) (- yp yb) gamma))
         (wz (overlap1d l1 l2 (- zp za) (- zp zb) gamma)))
    (* pre wx wy wz)))
...
(setf ra '(0.0 0.0 0.0))
(setf rb '(0.5 0.8 -0.2))
(assert (approx (tho66 za zb ra rb '(0 0 0) '(0 0 0)) 0.20373275913014607 1e-16))
(assert (approx (tho66 za zb ra rb '(1 0 0) '(0 0 0)) 0.062005622343957505 1e-16))
(assert (approx (tho66 za zb ra rb '(1 1 0) '(1 1 0)) -0.00043801221837779696 1e-16))
(assert (approx (tho66 za zb ra rb '(2 1 0) '(1 1 0)) -0.0002385994651113168 1e-16))
